# my-portfolio
Professional Portfolio for Larissa Johnstone
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="contact-info">
        <strong>Senior IT Project Manager</strong> | PMP® | CompTIA Security+ | ITIL® v4 | Active Secret Clearance <br>
DC Metro Area | (571) 420-5996 | johnstonelarissa@outlook.com
    </div>
    <h2>💼 Professional Profile</h2>
    <p>Highly accomplished and strategic Senior IT Project Manager with over 8 years of success directing enterprise-level government software deployment, cloud architecture modernizations, and complex systems integration programs. Proven track record leading cross-functional engineering and software development teams through the complete Software Development Life Cycle (SDLC), leveraging both Adaptive and Predictive methodologies.</p>
    <h2>🎯 Core Expertises</h2>
    <ul>
<li><span class="highlight">Project & Portfolio Management:</span> Enterprise IT Project Management, SDLC, Agile/Predictive Hybrid Delivery, Risk Mitigation.</li>
<li><span class="highlight">ITSM & Cloud Solutions:</span> IT Service Management (ITSM), ITIL Framework, O365/SharePoint Architecture, Cloud Migrations, ServiceNow, BMC Remedy.</li>
<li><span class="highlight">Automation & Next-Gen Tech:</span> Generative AI Governance, Prompt Engineering, LLMs, Power BI & Data Analytics, Mobile Device Management (MDM).</li>
    </ul>
    <h2>📈 Featured Case Study: Enterprise O365 Migration & SharePoint Architecture Modernization</h2>
    <div class="meta">
        <strong>Role:</strong> Senior IT Project Manager / Technical Consultant <br>
...
<li><span class="highlight">Seamless Transition:</span> Migrated enterprise data assets to the cloud with zero unscheduled downtime, preserving total operational continuity.</li>
        ...
        <li><span class="highlight">Process Efficiency:</span> Automated manual document approval workflows using integrated O365 cloud tools, reducing cycle times for internal administrative reviews.</li>
    </ul>
</body>
</html></body>
</html>
